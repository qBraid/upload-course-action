...
class Config:
    ...
    # API Configuration
    DEFAULT_API_BASE_URL: str = "https://preview---qbraid-api-ba7t34t2nq-uc.a.run.app/api/v1"
    # DEFAULT_API_BASE_URL: str = "https://2099-117-213-55-133.ngrok-free.app/app1/api/v1"
